...
export const addNewCategory = async (createCategory) => {
  ...
  return await limsApiClient.post(`/categories`, createCategory, {
    headers: authHeader(),
  });
};
...
export const getCategoryById = async (id) => {
  return await limsApiClient.get(`/categories/${id}`, {
    headers: authHeader(),
  });
};
...
export const autoSearchCategory = async (searchString) => {
  return await limsApiClient.get(`categories/search/${searchString}`, {
    headers: authHeader(),
  });
};
...
export const updateCategory = async (updateCategoryObj) => {
  return await limsApiClient.put(`/categories`, updateCategoryObj, {
    headers: authHeader(),
  });
};
...
export const deleteCategoryById = async (id) => {
  return await limsApiClient.delete(`/categories/${id}`, {
    headers: authHeader(),
  });
};
