...
import ProcedureTypeModal from "../../operationtheater/proceduretype/ProcedureTypeModal"
export default function ProcedureType() {
  let searchValue = "";
  ...
  return (
    <div className="w-full grid pt-10 px-6 mt-8 md:rounded-md">
      ...
      <div className="flex gap-2 w-full items-center mt-2">
          ...
          <h1 className="text-xl text-gray-700 font-Poppins hidden lg:block lg:w-[24%] md:w-[0%]">
          Procedure Type
          </h1>
        ...
        <div className="flex w-full lg:grid grid-cols-2 gap-2 items-center ">
          <div className="grid w-full grid-cols-1">
            <SearchBar
              ...
              placeholder="Search by Procedure Code / Description"
              dataArray={options}
