...
export default function City() {
  ...
  const handleChange = (autoSearchString) => {
    ...
    if (autoSearchString !== "") {
      ...
      autoSearchCity(autoSearchString)
  ...
  function editRow(cityInfo) {
    setEdit(true);
    console.log(cityInfo);
    console.log(cityInfo.Id);
    setIdValue(cityInfo.Id);
    ...
    <>
      <div className="w-full grid pt-10 px-6 mt-8 md:rounded-md">
        <div className="flex justify-center text-xl">
          <h1 className="text-black font-Poppins lg:hidden ">City</h1>
        </div>
          ...
          <div className=" flex items-center w-full gap-2">
            ...
            <div className="flex gap-2 items-center w-full xl:w-3/4">
              <SearchBar
                ...
                placeholder="Search by City Code/City"
                dataArray={options}
