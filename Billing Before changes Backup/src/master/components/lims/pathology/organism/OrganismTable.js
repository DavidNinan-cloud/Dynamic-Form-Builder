...
export default function OrganismTable(props) {
                            ...
                            >
                              <TableCell className="whitespace-nowrap">
                                <DriveFileRenameOutlineIcon
                                  ...
                                  onClick={(e) => {
                                    props.setOpen(true);
                                    props.editRow(organism);
                                  }}
                                />
                                <DeleteOutlineOutlinedIcon
                                  className="text-red-500 hover:cursor-pointer"
                                  onClick={() => props.deleteRow(organism)}
                                />
                              </TableCell>
                              <TableCell className="whitespace-nowrap">
                                {organism?.srNo}
                              ...
                              <TableCell className="whitespace-nowrap">
                                {organism?.createdDate}
                              </TableCell>
                              <TableCell className="whitespace-nowrap">
                                {organism?.lastModifiedBy}
                              </TableCell>
                              <TableCell className="whitespace-nowrap">
                                {organism?.lastModifiedDate}
                              </TableCell>
                            </TableRow>
                          );
                        })}
