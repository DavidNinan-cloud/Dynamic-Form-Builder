...
import { addNewCompany } from "../../services/organization/CompanyServices";
...
export default function CompanyModal(props) {
  ...
  const { mutate: postCompany } = useMutation(addNewCompany, {
    onSuccess: (res) => {
      const result = {
  ...
  return (
    <>
      ...
      <div className="w-full grid justify-center items-center rounded lg:px-0 mt-4">
        ...
        >
          <Box sx={ModalStyle} className="max-h-auto w-[80%] p-2">
            ...
            <div className="row">
              <fieldset className="border border-gray-300 text-left   lg:mx-auto lg:px-2 md:ml-0 md:mr-0 py-2 rounded  lg:mt-6 lg:m-2">
                <legend className="md:mx-2 lg:px-2 font-bold text-gray-800">
                  Company
                </legend>
                <form
                ...
                >
                  ...
                  <div className="flex gap-4 justify-end">
                    <div className="flex gap-4 -ml-10 md:px-2">
                      {props.edit ? (
                        <CancelButton
                          onClick={() => {
                            props.handleClose();
