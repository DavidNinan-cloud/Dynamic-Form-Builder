                ...
                <TableHead>
                  ...
                  >
                    ...
                    >
                      <TableSortLabel
                        active={false} //arrow for sorting
                        direction={orderBy === "departmentCode" ? order : "asc"}
                        onClick={createSortHandler("srNo")}
                      >
                    ...
                    <TableCell
                      sortDirection={
                        orderBy === "departmentName" ? order : false
                      }
                      className="whitespace-nowrap"
                    >
                      <TableSortLabel
                    ...
                    >
                      <TableSortLabel
                        active={false} //arrow for sorting
                        direction={orderBy === "deptIsClinical" ? order : "asc"}
                        onClick={createSortHandler("deptIsClinical")}
                      >
                        <span className="text-gray-600 font-bold">
                          deptIsClinical
                        </span>
                        {orderBy === "deptIsClinical" ? (
                          <Box component="span" sx={visuallyHidden}>
                            {order === "desc"
                              ? "sorted descending"
                              : "sorted ascending"}
