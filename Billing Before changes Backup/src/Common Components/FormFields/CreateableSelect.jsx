...
const CreateableSelect = ({
  ...
  control, 
    ...
    onInputChange}) => {
      ...
      //         top: placeholdernotVisible ? "" : isSearchable ? (state.menuIsOpen || state.selectProps.menuIsOpen || state.hasValue || state.selectProps.inputValue ? -12 : 4):(state.menuIsOpen || state.selectProps.menuIsOpen || state.hasValue || state.selectProps.inputValue ? -14  : 4), 
