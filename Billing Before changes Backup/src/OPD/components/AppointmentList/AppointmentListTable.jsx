...
export default function AppointmentListTable(props) {
  ...
  const headers = removeHeaders(allHeaders, ["unitId","cashBalance","id","patientId","patientVisitId","Appointment Id","doctorId","Department Id","patientCategoryId","patientAge",'patientCategory', 'company',]);
