...
function PatientFallAssessment() {
  ...
  // end
  const [totalScore, setTotalScore] = React.useState(0); // totalScore

  const [ageValue, setAgeValue] = React.useState(0);
  const [fallHistoryValue, setFallHistoryValue] = React.useState(0);
  const [eliminationValue, setEliminationValue] = React.useState(0);
  const [medicationsValue, setMedicationsValue] = React.useState(0);
  const [patientCareValue, setPatientCareValue] = React.useState(0);
  const [mobilityValue, setMobilityValue] = React.useState(0);
  const [cognitionValue, setCognitionValue] = React.useState(0);
  ...
  const onChangeAgeValue = (ev) => {
    //save your value here with state variable
    console.log(ev.target.value);
    setAgeValue(ev.target.value);
  };
  const onChangeFallHistoryValue = (ev) => {
    //save your value here with state variable
    console.log(ev.target.value);
    setFallHistoryValue(ev.target.value);
  };
  const onChangeElimainationValue = (ev) => {
    //save your value here with state variable
    console.log(ev.target.value);
    setEliminationValue(ev.target.value);
  };
  const onChangeMedicationsValue = (ev) => {
    //save your value here with state variable
    console.log(ev.target.value);
    setMedicationsValue(ev.target.value);
  };
  const onChangePatientCareValue = (ev) => {
    //save your value here with state variable
    console.log(ev.target.value);
    setPatientCareValue(ev.target.value);
  };
  const onChangeMobilityValue = (ev) => {
    //save your value here with state variable

    console.log(mobilityValue);
    if (ev.target.checked) {
      setMobilityValue(mobilityValue + 2);
    } else {
      if (mobilityValue !== 0) {
        setMobilityValue(mobilityValue - 2);
      }
  ...
  const onChangeCognitionValue = (ev) => {
    //save your value here with state variable
    console.log("cognitionValue", cognitionValue);
    if (ev.target.checked) {
      setCognitionValue(cognitionValue + 1);
    } else {
      if (cognitionValue !== 0) {
        setCognitionValue(cognitionValue - 1);
      }
  ...
  const onChangeCognitionValueTwo = (ev) => {
    //save your value here with state variable
    console.log("cognitionValue", cognitionValue);
    if (ev.target.checked) {
      setCognitionValue(cognitionValue + 2);
    } else {
      if (cognitionValue !== 0) {
        setCognitionValue(cognitionValue - 2);
      }
  ...
  const onChangeCognitionValueThree = (ev) => {
    //save your value here with state variable
    console.log("cognitionValue", cognitionValue);
    if (ev.target.checked) {
      setCognitionValue(cognitionValue + 4);
    } else {
      if (cognitionValue !== 0) {
        setCognitionValue(cognitionValue - 4);
      }
  ...
  return (
    <div className="mx-2">
      ...
      >
        ...
        completeIsChecked === false ? (
          <div>
            ...
            <PatientFallAssessmentTable
              ...
              onChangeFallHistoryValue={onChangeFallHistoryValue}
              onChangeEliminationValue={onChangeElimainationValue}
              onChangeMedicationsValue={onChangeMedicationsValue}
              onChangePatientCareValue={onChangePatientCareValue}
              onChangeMobilityValue={onChangeMobilityValue}
              onChangeCognitionValue={onChangeCognitionValue}
              onChangeCognitionValueTwo={onChangeCognitionValueTwo}
              onChangeCognitionValueThree={onChangeCognitionValueThree}
              ageValue={ageValue}
              fallHistoryValue={fallHistoryValue}
              eliminationValue={eliminationValue}
              medicationsValue={medicationsValue}
              patientCareValue={patientCareValue}
              mobilityValue={mobilityValue}
              cognitionValue={cognitionValue}
        ...
        <div className="border border-b border-customBlue"> </div>
