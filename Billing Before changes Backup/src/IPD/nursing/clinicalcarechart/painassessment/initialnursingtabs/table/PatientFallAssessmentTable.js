...
export default function BasicTable({ showTableButton }) {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(submitForm)}>
        ...
        {showTableButton === true && patientFallInfo === "" ? (
