...
import IpdPythalogyInvestigation from "./commonipdcards/IpdPythalogyInvestigation";
...
const EmrMale = () => {
  ...
  const [pythalogyInvestigations, setPythalogyInvestigations] = useState([]);
  ...
  return (
    <div className="mt-16 pt-2 mb-4">
      ...
      <Grid container columnSpacing={0} rowSpacing={0}>
        ...
        <Grid item lg={6} sm={6}>
          <IpdPythalogyInvestigation
            pythalogyInvestigations={pythalogyInvestigations}
          />
        </Grid>
