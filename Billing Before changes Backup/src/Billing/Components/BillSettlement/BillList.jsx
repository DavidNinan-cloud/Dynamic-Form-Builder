...
export default function BillList(props) {
    ...
    const { setBillInfo, resetBillInfo, tableApiFunc , dataResult , setDataResult, page, setPage, rowsPerPage, setRowsPerPage, count} = props
                                   ...
                                   <ControlledCheckBoxField
                                      ...
                                      onChange={(value) => {
                                              if(checkIndex[index] !== index){
                                                setCheckIndex(index)
                                                setBillInfo(row,index)
                                              }else{
                                                setCheckIndex(null)
                                                resetBillInfo(row,index)
                                              }
                                          }}
