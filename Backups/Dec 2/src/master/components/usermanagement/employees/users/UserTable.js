    ...
    tableApiFunc(defaultParams)
      ...
      .then((res) => {
        ...
        res.result.forEach((jsonString) => {
          ...
          UnitList.push(jsonObject);
        });

        let incomingData = UnitList;
                  ...
                  >
                    ...
                    >
                      <TableSortLabel
                        ...
                        onClick={createSortHandler("EmployeeCode")}
                      >
                    ...
                    <TableCell
                      sortDirection={orderBy === "EmployeeName" ? order : false}
                      className="whitespace-nowrap"
                    >
                      <TableSortLabel
                        active={false} //arrow for sorting
                    ...
                    >
                      <TableSortLabel
                        ...
                        onClick={createSortHandler("User Name")}
                      >
                        <span className="text-gray-600 font-bold">
                          User Name
                        </span>
                    ...
                    <TableCell
                      sortDirection={
                        orderBy === "deptIsClinical" ? order : false
                      }
                      className="whitespace-nowrap"
                    >
                      <TableSortLabel
                      ...
                      >
                        <span className="text-gray-600 font-bold">Roles</span>
                        {orderBy === "roles" ? (
                          <Box component="span" sx={visuallyHidden}>
                            {order === "desc"
                              ? "sorted descending"
                    ...
                    >
                      <TableSortLabel
                        active={false} //arrow for sorting
                        direction={
                          orderBy === "unidepartmentsts" ? order : "asc"
                        }
