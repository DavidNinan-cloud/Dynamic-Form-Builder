...
import {
  autoSearchTypeOfAppointment,
  fetchAllTypeOfAppointment,
  deleteTypeOfAppointmentById,
} from "../../services/appointment/TypeOfAppointmentServices";
import CommonBackDrop from "../../../Common Components/CommonBackDrop/CommonBackDrop";
//fromfield control liberary componant import
import SearchBar from "../../../Common Components/FormFields/SearchBar";
import TypeOfAppointmentModal from "./TypeOfAppointmentModal";
...
export default function TypeOfAppointment() {
  ...
  const autoSelectedValue = (value) => {
    ...
    if (value === null) {
      ...
      searchValue = value.AppointmentType;
    }
  };

  //event listener function for edit icon
  function editRow(typeofappointment) {
    setEdit(true);
    console.log(typeofappointment);
    console.log(typeofappointment.Id);
    setIdValue(typeofappointment.Id);
    ...
    <>
      ...
      <div className="w-full grid pt-10 px-6 mt-8 md:rounded-md">
        ...
        <div className="flex gap-2 w-full items-center mt-2">
          ...
          <h1 className="text-xl text-gray-700 font-Poppins hidden lg:block lg:w-[30%] md:w-[0%]">
            Type Of Appointment
          </h1>
