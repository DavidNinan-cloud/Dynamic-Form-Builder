...
import ModalICDCode from "./ModalICDCode";
import SearchBar from "../../../../Common Components/FormFields/SearchBar";
import ConfirmationModal from "../../../../Common Components/ConfirmationModal";
import AddNewButton from "../../../../Common Components/Buttons/AddNewButton";
//  International Classification of Diseases
// International Classification of Diseases, (ICD-10-CM/PCS) like :
...
export default function ICDCode() {
  ...
  const handleChange = (autoSearchString) => {
    if (autoSearchString !== "") {
      ...
      autoSearchICDCode(autoSearchString)
  ...
  const autoSelectedValue = (value) => {
    ...
    if (value === null) {
      ...
      searchValue = value.icdcode;
    }
  };

  //event listener function for edit btn
  const editRow = (icdcode) => {
    setEdit(true);
    console.log(icdcode);
    console.log(icdcode.Id);
    setIdValue(icdcode.Id);
    handleOpen();
  };
          ...
          <div className="grid grid-cols-6 w-full gap-2 items-center ">
            <div className="w-full col-span-3 xl:col-span-2">
              <SearchBar
                ...
                placeholder="Search by ICDCode/Description"
                dataArray={options}
