...
export default function DoctorListingTable(props) {
  ...
  const handleEditForm = (
    ...
    console.log("drdepartmentid", drdepartmentid);
    ...
    const params = {
      ...
      departmentId: drdepartmentid,
      doctorName: doctorname,
    };

    // navigate({
    //   pathname: "/masters/scheduling/scheduling",
    //   search: `${createSearchParams(params)}`,
    // });

    navigate("/masters/scheduling/scheduling", {
      state: params,
    });
  };
