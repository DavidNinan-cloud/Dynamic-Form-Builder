  ...
  return (
    <div className="w-full px-6">
      <div className="container  w-[100%] grid px-2 lg:px-5  pt-10  mt-8 md:rounded-md">
        {/* <div>
          {scheduleData && scheduleData.isCultureTest === true ? (
            <b>isCultureTest True</b>
          ) : (
            <b> isCultureTest False</b>
          )}
          {scheduleData && scheduleData.isTemplate === true ? (
            <b>isTemplate True</b>
          ) : (
            <b> isTemplate False</b>
          )}
        </div> */}
