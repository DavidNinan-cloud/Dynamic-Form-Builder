...
export default function PaymentHistoryTable(props) {
  ...
  const {showPaymentHistory, paymentBill, printView, visitId, tableApiFunc , dataResult , setDataResult, page, setPage, rowsPerPage, setRowsPerPage, count} = props
  ...
  const [paymentAction, setPaymentAction] = React.useState(true);
  const [paymentHistoryAction, setPaymentHistoryAction] = React.useState(true);
  ...
  const headers = removeHeaders(allHeaders, ["id","billId","cashBalance",'paymentId']);
  ...
  return (
    <div className=" mx-auto w-full">
      <Box sx={{ width: "100%", maxWidth:{sm:'40rem', md:'40rem', lg:'100%'} }}>
