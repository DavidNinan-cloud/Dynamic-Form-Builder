...
import IPDCharge from "../../Billing/Components/ipdCharges/IPDCharge";
...
import TestDetails from "../../master/components/lims/pathology/testDetails.js/TestDetails";
import TestCreation from "../../master/components/lims/radiology/testCreation/TestCreation";
import PathologyProfile from "../../master/components/lims/pathology/pathologyProfile/PathologyProfile";
import PathologyMachineParameterLinking from "../../master/components/lims/pathology/machineParameterLinking/PathologyMachineParameterLinking";
...
import ClinicalCareChart from "../../IPD/nursing/clinicalcarechart/ClinicalCareChart";
import DrugAdministrationChart from "../../IPD/nursing/drugAdministrationChart/DrugAdministrationChart";
import BedAllocation from "../../IPD/components/bedallowcation/BedAllocation";
import BedAllowModal from "../../IPD/components/bedallowcation/BedAllowModal";
...
import WorkOrderViewRad from "../../LIMS/Radiology/components/workOrderView/WorkOrderView";
...
import AdmissionForm from "../../IPD/components/admission/admissionform/AdmissionForm";
import AdmissionList from "../../IPD/components/admission/admissionlist/AdmissionList";
...
import PharmacySales from "../../pharmacy/counterCell/CounterSales";
import OTBooking from "../../IPD/OT/OTBooking/OTBooking";
//Import Inventory
import PurchaseEnquiry from "../../Inventory/Components/PurchaseEnquiry/PurchaseEnquiry";
import PurchaseQuotation from "../../Inventory/Components/PurchaseQuotation/PurchaseQuotation";
// import OTSchedualing from "../../OT/OTSchedualing";
import PurchasOrder from "../../Inventory/Components/purchasorder/PurchasOrder";
import IncomeReports from "../../Reports/IncomeReports";
import BillCancellation from "../../Billing/Components/BillCancellation/BillCancellation";
import RefundPage from "../../Billing/Components/RefundPage/RefundPage";
import BillSettlement from "../../Billing/Components/BillSettlement/BillSettlement";
import StoreIndent from "../../Inventory/Components/storeIndent/StoreIndent";
import OTConsent from "../../IPD/OT/otconsent/OTConsent";
import IssueReturnIndent from "../../Inventory/Components/requisition/IssueReturnIndent";
import OTBookingList from "../../IPD/OT/OTListing/components/OTBookingList";
//New Component Import
import ConsentMaster from "../../master/components/operationtheater/ot/ConsentMaster";
import InPatientIssue from "../../pharmacy/inpatientissue/InPatientIssue";

import PatientBillInfo from "../../Billing/Components/PatientBillInfo/PatientBillInfo";
import PackageCreation from "../../master/components/billing/packages/PackageCreation";
import CategoryRateMatrix from "../../master/components/billing/service/ot/category-rate-matrix/CategoryRateMatrix";
import IpdEmr from "../../IPD/components/ipdemr/IpdEmr";
import IPDCharges from "../../IPD/components/ipdCharges/IPDCharges";
import StockAdjustment from "../../pharmacy/counterCell/StockAdjustment";
import ExpiryAdjustment from "../../pharmacy/counterCell/ExpiryAdjustment";
import MrpAdjustment from "../../pharmacy/counterCell/MrpAdjustment";
import StoreStockMinMax from "../../pharmacy/counterCell/StoreStockMinMax";

//Import House Keeping
import WasteBagTransaction from "../../HouseKeeping/Components/WasteBagTransaction";
...
export default function Layout() {
  ...
  useEffect(() => {
    ...
    if (login !== null || login === false) {
      tokenInfo = localStorage.getItem("loggedUser");
      if (tokenInfo !== null) {
        console.log("Login Statussss1", login);
        getDrawerMenu();
      }
    }
  }, [login]);
  ...
  //Global Search Option API
  const handleInputChange = (value) => {
    if (value.length > 0) {
      getGlobalSearchOption(value)
        .then((response) => {
  ...
  //Navigation To List with Searched Value
  useEffect(() => {
    let params;
    if (selectedValue !== null) {
      ...
      navigate("/opd/patientlist", { state: params });
    }
  }, [selectedValue]);
              ...
              <AppBar position="fixed" open={open}>
                ...
                >
                  ...
                  <img
                    src={logo}
                    alt="logo"
                    className="h-8 ml-2 hover:cursor-pointer"
                  ...
                  <div className="w-full mr-4">
                    <div className="flex justify-end space-x-2 lg:space-x-6 items-center">
                      {/* //Global Searchbar// */}
                      <GlobalSearchBar
                        type="button"
                        ...
                        onChange={(e) => {
                          ...
                          if (e !== null) {
                            setSelectedValue(e.mobileNumber);
                          } else {
                                          ...
                                          null ? (
                                                            ...
                                                            null ? (
                                                              ...
                                                              >
                                                                ...
                                                                >
                                                                  ...
                                                                  // onClick={handleDrawerClose}
                                                                  >
                                                                    <p className="text-sm -ml-4 py-1 h-auto font-Poppins text-ellipsis whitespace-normal">
                                                                      {
                                                                        item.functionality
                                                                      }
                                                                    </p>
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                // onClick={handleDrawerClose}
                                                >
                                                  <p className="text-sm -ml-5 h-auto py-1 font-Poppins text-ellipsis whitespace-normal">
                                                    {item.functionality}
                                                  </p>
                                                </ListItemText>
                                              </ListItemButton>
                          ...
                          >
                            ...
                            >
                              <ListItemText
                                ...
                                // onClick={handleDrawerClose}
                              >
                                <p className="font-bold text-sm -ml-5 py-1 h-auto font-Poppins text-ellipsis">
                                  {row.functionality}
                                </p>
                              </ListItemText>
                            </ListItemButton>
              ...
              >
                ...
                <>
                  ...
                  <Routes>
                    ...
                    <Route path="/pharmacy">
                      <Route
                        path="/pharmacy/inpatientissue"
                        element={<InPatientIssue />}
                      />
                      <Route
                        path="/pharmacy/countersales"
                        element={<PharmacySales />}
                      />
                      <Route
                        path="/pharmacy/stockAdjustment"
                        element={<StockAdjustment />}
                      />
                      <Route
                        path="/pharmacy/expiryAdjustment"
                        element={<ExpiryAdjustment />}
                      />
                      <Route
                        path="/pharmacy/mrpAdjustment"
                        element={<MrpAdjustment />}
                      />
                      <Route
                        path="/pharmacy/storeStockMinMax"
                    ...
                    <Route path="/ipd">
                      ...
                      <Route
                        ...
                        element={<BedTransfer />}
                      />
                      <Route path="/ipd/charges" element={<IPDCharges />} />
                    ...
                    {/* //Clinical// */}
                    <Route path="/ipd">
                      <Route path="/ipd/emr" element={<IpdEmr />} />
                    </Route>

                    {/* OTBooking */}
                    <Route path="/ot">
                      <Route path="/ot/otbooking" element={<OTBooking />} />

                      <Route path="/ot/otconsent" element={<OTConsent />} />

                      <Route
                        path="/ot/otbookinglist"
                        element={<OTBookingList />}
                      />
                    </Route>
                    ...
                    <Route path="/billing">
                      <Route
                        path="/billing/opd"
                        element={<OPDBill drawerOpen={open} />}
                      />
                      <Route
                        path="/billing/ipd"
                        element={<IPDBill drawerOpen={open} />}
                      />
                      <Route
                        path="/billing/billcancellation"
                        element={<BillCancellation drawerOpen={open} />}
                      />
                      <Route
                        path="/billing/refund"
                        element={<RefundPage drawerOpen={open} />}
                      />
                      <Route
                        path="/billing/billsettlement"
                        element={<BillSettlement drawerOpen={open} />}
                      />
                      <Route
                        path="/billing/paymentrefund"
                        element={<Refund />}
                      />
                      <Route path="/billing/class" element={<Class />} />
                      <Route
                    ...
                    <Route path="/lims">
                      ...
                      <Route path="/lims/radiology">
                        <Route
                          path="/lims/radiology/workOrderView"
                          element={<WorkOrderViewRad />}
                        />
                      </Route>
                    </Route>
                    ...
                    />
                    <Route
                      path="/masters/organization/subdepartments"
                    ...
                    <Route path="/masters/usermanagement">
                      ...
                      />
                      <Route
                        path="/masters/usermanagement/employeetype"
                    ...
                    <Route path="/masters/opd/icdcode" element={<ICDCode />} />
                    <Route
                    ...
                    />
                    <Route path="/masters/opd/allergy" element={<Allergy />} />
                    <Route
                    ...
                    {/* <Route path="/masters/ot/consentmasters" element={<ConsentMaster />} /> */}
                    ...
                    <Route
                      ...
                      element={<District />}
                    />
                    <Route path="/masters/area/talukas" element={<Taluka />} />
                    <Route path="/masters/area/cities" element={<City />} />
                    <Route path="/masters/area/pinCode" element={<Pincode />} />
                    ...
                    />
                    <Route path="emergency/emergency" element={<Emergency />} />
                    <Route path="masters/prefix" element={<PatientPrefix />} />
                    ...
                    <Route path="/masters/lims">
                      ...
                      <Route path="/masters/lims/pathology">
                        ...
                        />
                        <Route
                          path="/masters/lims/pathology/pathologymachineparameterlinking"
                      ...
                      <Route path="/masters/lims/radiology">
                        ...
                        />
                        <Route
                          path="/masters/lims/radiology/testCreation"
                    ...
                    <Route path="/inventory">
                      <Route
                        path="/inventory/purchaseenquiry"
                        element={<PurchaseEnquiry />}
                      ></Route>
                      <Route
                        path="/inventory/purchasequotation"
                      ...
                      />
                      <Route
                        path="/inventory/storeindent"
                        element={<StoreIndent />}
                      />
                      <Route
                        path="/inventory/issuereturnindent"
                        element={<IssueReturnIndent />}
                      />
                    </Route>
                    ...
                    <Route
                      ...
                      element={<PatientCategory />}
                    />
                    <Route path="masters/billing/class" element={<Class />} />
                    <Route
                      path="masters/billing/paymenttype"
                      element={<Payment />}
                    />
                    <Route path="masters/billing/tariff" element={<Tariff />} />
                    <Route path="masters/billing/group" element={<Group />} />
                    <Route
                      path="masters/billing/subgroup"
                      element={<SubGroup />}
                    />
                    {/* operation theater masters */}
                    <Route path="/masters/operationtheater">
                    ...
                    <Route
                      path="/masters/billing/categoryratematrix"
                      element={<CategoryRateMatrix />}
                    />
                    ...
                    <Route path="/houseKeeping">
                      <Route
                      path="/houseKeeping/wasteBagTransaction"
                      element={<WasteBagTransaction/>}
                      />
                    </Route>
                    {/* <Route
                      path="/OT/OTSchedualing"
                      element={<OTSchedualing />}
                    /> */}
                    {/* //New Routes// */}
                    <Route
                      path="/masters/operationtheater/consentmaster"
                      element={<ConsentMaster />}
                    />
                    <Route
                      path="/billing/patientbillinfo"
                      element={<PatientBillInfo />}
                    />
                    <Route
                      path="/masters/billing/packagecreation"
                    ...
                    {reportsRoutes &&
                      reportsRoutes.map((routeElement, index) => {
                        ...
                        return (
                          <>
                            {routeElement.routerLink !==
                            "/reports/transactionrevenue" ? (
                              <Route
