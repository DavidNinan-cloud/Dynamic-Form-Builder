...
import { vitalContext, pathologyInvestigationContext } from "./Context";
  ...
  return (
    <div className="mt-16 pt-2 mb-4">
      ...
      <Grid container columnSpacing={0} rowSpacing={0}>
        ...
        <Grid item lg={6} sm={6}>
          <pathologyInvestigationContext.Provider
            value={{ pathologyInvestigations }}
          >
        ...
        {/* //General Examination// */}
        <Grid item lg={6} sm={6}>
          <vitalContext.Provider value={{ vitalsValue }}>
