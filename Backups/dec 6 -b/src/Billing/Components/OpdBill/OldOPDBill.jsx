...
const BottomStyledTableCell = styled(TableCell)(({ theme }) => ({
    [`&.${tableCellClasses.body}`]: {
    background: "#FFFFFF",
    position: "sticky",
    top: "0px",
...
export default function OldOPDBill({ drawerOpen }) {
    ...
    const discountTotal = watch('discountTotal')
    const netTotal = watch('netTotal')
    const gstTotal = watch('gstTotal')
    const afterGstTotal = watch('afterGstTotal')
    const companyTotal = watch('companyTotal')
    const selfTotal = watch('selfTotal')
    ...
    const onSubmit = (data) => {
        ...
        if (isCompany && comingData.CompanyId) {
        ...
        if (TableData.length > 0) {
            ...
            for (let i = 0; i < TableData.length; i++) {
                ...
                if (
                    ...
                    // newChanges
                    if(!isError){
                        if (Number(TableData[i].serviceWDiscountTotal) < 0) {
                            isError = true
                                                        ...
                                                        <TableHead>
                                                            ...
                                                            >
                                                                ...
                                                                <TableCell className="" sx={{ width: '6rem' }} >
                                                                    <span className=" text-sm tracking-wide font-bold whitespace-nowrap ">Service Desc</span>
                                                                </TableCell>
                                                                {/* <TableCell className="" sx={{ width: '6rem' }}>
                                                                ...
                                                                <TableCell className="" sx={{ width: '4rem' }}>
                                                                    <span className=" font-bold whitespace-nowrap  mx-auto text-sm tracking-wide">Total (₹)</span>
                                                                </TableCell>
                                                                {
                                                                    showGst ? (<>
                                                                        {/* gst */}
                                                                        <TableCell className="justify-center flex" sx={{ width: '8rem' }}>
                                                                            <span className=" text-sm tracking-wide font-bold whitespace-nowrap text-center w-fit">Gst Amt</span>
                                                                        </TableCell>
                                                                        {/* net total */}
                                                                        <TableCell className="justify-center flex" sx={{ width: '8rem' }}>
                                                                ...
                                                                }
                                                                {
                                                                    isCompany ? (<>
                                                                        {/* company balance */}
                                                                        <TableCell className="justify-center flex" sx={{ width: '8rem' }}>
                                                                            <span className=" text-sm tracking-wide font-bold whitespace-nowrap text-center w-fit">Comp Bal</span>
                                                                        </TableCell>
                                                                        {/* self balance */}
                                                                        <TableCell className="justify-center flex" sx={{ width: '8rem' }}>
                                                                            <span className=" text-sm tracking-wide font-bold whitespace-nowrap text-center w-fit">Self Bal</span>
                                                                        </TableCell>
                                                                            ...
                                                                            return (
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <TableCell className="flex" sx={errors.Services?.[index] ? { paddingBottom: '2rem', width: '2rem' } : { width: '2rem' }}>
                                                                                        {row.serviceCode} || {row.isBilled ? (<>{row.serviceName}
                                                                        ...
                                                                        })}
                                                                    {
                                                                        TableData.length !== 0 ? (<>
                                                                            ...
                                                                            {showBreakdown ? (
                                                                                ...
                                                                                >
                                                                                    {/* 1 */} <StyledTableCell></StyledTableCell>
                                                                                    {/* 2 */} 
                                                                                    {/* <TableCell></TableCell> */}
                                                                                    {/* 3 */} <StyledTableCell></StyledTableCell>
                                                                                    {/* 4 */} <StyledTableCell>
                                                                                    ...
                                                                                    {/* 6 */} <StyledTableCell></StyledTableCell>
                                                                                    {/* 7 */} <StyledTableCell>
                                                                                        {showDiscount ? (
                                                                                            <fieldset disabled={true}>
                                                                                                <span className="tracking-wide capitalize text-right font-bold mt-4">
                                                                            ...
                                                                            <TableRow sx={!showBreakdown ? {
                                                                                ...
                                                                                <BottomStyledTableCell colSpan={4}
                                                                                    sx={{ fontSize: 14 
                                                                                ...
                                                                                </BottomStyledTableCell>
                                                                                {
                                                                                    strTotal !== '' ? (
                                                                                        <>
                                                                                            <BottomStyledTableCell align="right" colSpan={2} >
                                                                                                <span className="tracking-wide capitalize text-right font-bold mt-4">
                                                                                                    Total Payable :
                                                                                                </span>
                                                                                            </BottomStyledTableCell>
                                                                                            <BottomStyledTableCell align="left" colSpan={2}>
                                                                                                <fieldset disabled={true}>
                                                                                                    <InputField
                                                                                                        variant="outlined"
                                                                                                        // disabled={true}
                                                                                            ...
                                                                                            </BottomStyledTableCell>
                                                                                            {
                                                                                                showGst ? (
                                                                                                    <>
                                                                                                        <BottomStyledTableCell></BottomStyledTableCell>
                                                                                                        <BottomStyledTableCell></BottomStyledTableCell>
                                                                                                    </>
                                                                                                ):''
                                                                                            }
