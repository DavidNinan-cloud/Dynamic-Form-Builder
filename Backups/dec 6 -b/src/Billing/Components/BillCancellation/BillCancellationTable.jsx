...
//main function
export default function BillCancellationTable(props) {
  //state varibale for the table
  const {cancelFunc, patientId, drawerOpen, tableApiFunc , dataResult , setDataResult, page, setPage, rowsPerPage, setRowsPerPage, count} = props
                            ...
                            {cancelAction ? (<>
                                <div className="flex items-center justify-center  space-x-1">
                                  <Tooltip title="Cancel Bill">
                                    <a
                                      href="##"
                                      className="text-red-500 mr-3 mb-2"
                                      onClick={() => cancelFunc(index,row)}
                                    >
                                      <CancelIcon
                                  />
                                    </a>
