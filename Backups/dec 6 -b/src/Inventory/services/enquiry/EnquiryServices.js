...
export const autoItemService = (itemTypeId, itemCategoryId, searchString) => {
  ...
  console.log("Search Service is " + JSON.stringify(searchString));
  return apiClient.get(
    `/item/search/${itemTypeId}/${itemCategoryId}/${searchString}`,
    {
      headers: authHeader(),
    }
  );
...
export const addNewEnquiry = async (createEnquiry) => {
  console.log(
    "Object sent for NEW ENQUIRY data record creation is " +
      JSON.stringify(createEnquiry)
  );
...
export const fetchAllEnquiry = async (searchEnquiryObj) => {
  ...
  return await apiClientInventory.post(
    `/enquiry/enquirylist`,
    searchEnquiryObj,
    {
      headers: authHeader(),
...
// search data ,Get request to fetch the autocomplete options
export const autoSearchEnquiry = (searchString) => {
  {
    /*inventory/enquiry/searchByItemAndEnquiryNo?searchString=e */
  }
  console.log("Search patient is " + JSON.stringify(searchString));
  return apiClientInventory.get(
    `/enquiry/searchByItemAndEnquiryNo?searchString=${searchString}`,
    {
      headers: authHeader(),
    }
  );
...
export const getEnquiryVisibility = (enquiryID) => {
  // /inventory/enquiry/getItemDetailsByEnquiry/{enquiryId}
  console.log("Visible Enquiry ID is:" + JSON.stringify(enquiryID));
  return apiClientInventory.get(
    `/enquiry/getItemDetailsByEnquiry/{enquiryId}`,
    { headers: authHeader() }
  );
};
