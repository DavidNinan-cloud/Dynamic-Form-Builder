...
import MedicoLegelModal from "./MedicoLegelCaseModal";
export default function IpdRegisterForm(props) {
  console.log("IPD REGISTERED FORM : ", props);
  ...
  //OPEN Medico Legel Case Modal
  const [openMedicoLegelCase, setOpenMedicoLegelCase] = React.useState(false);
  const handleOpenMedicoLegelCase = () => setOpenMedicoLegelCase(true);
  const handleCloseMedicoLegelCase = () => setOpenMedicoLegelCase(false);
  ...
  //mlc modal open
  let mlcType = watch("isMlc");
  console.log("mlcType is", mlcType);
  ...
  const onSubmitDataHandler = (data) => {
    ...
    console.log(data);
    if (props.patientInfo !== null && props.patientInfoId) {
      setOpenPost(true);
    }
    setFinalData(data);
  };
    ...
    <>
      <form onSubmit={handleSubmit(onSubmitDataHandler)} className="mx-2">
              ...
              <div className="grid border border-gray-300 bg-gray-100 px-3 rounded mt-2">
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 py-2">
                  <div className="grid gap-2 border-r-2 border-slate-500 my-1 ">
                    ...
                    <div className="flex gap-2 ">
                      <h1 className="text-black font-semibold flex space-x-11 lg:space-x-12">
                  ...
                  <div className="grid gap-2 lg:border-r-2 pl-4 border-slate-500 my-1 ">
                    <div className="flex gap-2 ">
                      <h1 className="text-black font-semibold flex space-x-16 lg:space-x-12">
                    ...
                    <div className="flex gap-2 ">
                      <h1 className="text-black font-semibold flex md:space-x-7 lg:space-x-3">
        ...
        <div className="grid lg:grid-cols-2   xl:gap-2">
          <div className="flex justify-between items-center lg:mr-3 lg:mt-6 lg:border-r-2 border-slate-500">
            {/* <CheckBoxField
              control={control}
              name="isMlc"
              label="Medico Legal Case"
              // onClick={(e) => {
              //   handleOpenMedicoLegelCase(e);
              //   console.log("hiiiiiiiii",e);
              // }}
            /> */}
      ...
      {/* {mlcType === true ? (
        <MedicoLegelModal
          open={openMedicoLegelCase}
          close={handleCloseMedicoLegelCase}
        />
      ) : (
        ""
      )} */}
