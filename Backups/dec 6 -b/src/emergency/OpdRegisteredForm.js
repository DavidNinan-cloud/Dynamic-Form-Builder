...
export default function OpdRegisteredForm(props) {
  console.log("OPD REGISTERED FORM : ", props);
  ...
  const onSubmitDataHandler = (data) => {
    ...
    if (props.patientInfoId !== null && props.patientInfo !== null) {
      ...
      for (let i = 0; i < serviceData.length; i++) {
        ...
        if (serviceData[i] !== null) {
          let obj = {};
          obj.serviceCode = serviceData[i].serviceccode;
          obj.serviceId = serviceData[i].id;
          services.push(obj);
        }
      }
  ...
  const addServiceData = () => {
    ...
    console.log("Service Value is:", services);
    let Qty = getValues("Qty");
    if (services !== null && Qty !== "") {
      ...
      console.log("ServiceData is", serviceObj);
    }
    // }
  };
              ...
              <div className="grid border bg-gray-100 border-gray-300 px-3 rounded mt-1">
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 py-2">
                  <div className="grid gap-2 border-r-2 border-slate-500 my-1 ">
                    ...
                    <div className="flex gap-2 ">
                      <h1 className="text-black font-semibold flex space-x-12 lg:space-x-12 xl:space-x-11">
