    ...
    <>
      {typeof props.patientInfo !== "undefined" ? (
        <div className="flex justify-between border shadow-md p-2 my-2 bg-gray-100 ml-3">
          ...
          <div className="grid grid-cols-3 xl:grid-cols-6 gap-0 lg:gap-2 w-full ">
            {/* //Profile Pic and Name// */}
            <div className="flex justify-between  xl:pr-4">
              <div className="flex items-center space-x-3 mr-4 overflow-hidden">
              ...
              />
                ...
                <div className="text-sm text-slate-600">
                  <h1 className="truncate">{props.patientInfo.patientName}</h1>
