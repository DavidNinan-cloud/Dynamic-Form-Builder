...
import AddDocuments from "./emrcomponents/AddDocuments";
...
const Documents = (props) => {
  ...
  const [documentPdf, setDocumentPdf] = React.useState("");
    ...
    <>
      <div className="">
        <Card
          ...
          className=" mx-auto h-[7.5rem] overflow-scroll scrollbar-thin  scrollbar-thumb-gray-300 scrollbar-track-slate-50"
        >
          <CardContent>
            <div className="flex justify-between py-2 bg-rose-50 -mt-2">
              <div className="text-sm font-semibold pl-2">Documents</div>
              <div>
                {props.documents !== null && props.documents.length > 0 ? (
                  <button
                ...
                {props.status && props.status.toLowerCase() !== "completed" ? (
                  ...
                  >
                    <Tooltip title="Add Documents" placement="left-start" arrow>
      ...
      >
        ...
        >
          <div className=" bg-white font-bold flex justify-between px-4">
            <p className="text-lg">Document Details</p>
            <Button
