...
export const fetchAllMachines = async (searchMachineObj) => {
  ...
  return await apiClient.post("machines/machinelist", searchMachineObj, {
    headers: authHeader(),
  });
};
...
export const addNewMachine = async (createMachine) => {
  ...
  return await apiClient.post(`/machines`, createMachine, {
    headers: authHeader(),
  });
};
...
export const updateMachine = async (updateMachineObj) => {
  return await apiClient.put(`/machines`, updateMachineObj, {
    headers: authHeader(),
  });
};
...
export const deleteMachineById = async (id) => {
  return await apiClient.delete(`/machines/${id}`, {
    headers: authHeader(),
  });
};
