...
export const fetchAllTests = async (searchTestsObj) => {
  ...
  return await apiClient.post("tests/radiologytestlist", searchTestsObj, {
    headers: authHeader(),
  });
};

export const fetchAllTemplates = async (templateObj) => {
  console.log(templateObj);

  return await apiClient.post("templates/templatelist", templateObj, {
    headers: authHeader(),
  });
};
...
export const autoSearchTestItem = async (searchString) => {
  return await apiClient.get(`tests/testitemsearch/${searchString}`, {
    headers: authHeader(),
  });
};
...
export const getModalityDropdown = () => {
  return apiClient.get(`modality/dropdown`, {
    headers: authHeader(),
  });
};
