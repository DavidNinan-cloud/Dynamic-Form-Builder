...
export default function PatientEngagement() {
    ...
    result: [
      {
        ...
        PatientType: "OPD",
        AddedBy: "Vishal Pawar",
        Description: "Other Consultant Reference,Cardiac OPD,Radiology",
        Upload: "",
      },
      {
        Id: 2,
        ...
        PatientType: "IPD",
        AddedBy: "Sahil Bhowate",
        Description: "Cardiac OPD,PharmacyPathology",
        Upload: "",
      },
      {
        Id: 3,
        ...
        PatientType: "OPD",
        AddedBy: "Pankaj Wani",
        Description: "Pathology,Cardiac OPD",
        Upload: "",
      },
      {
        Id: 4,
        ...
        PatientType: "IPD",
        AddedBy: "Yash S",
        Description: "Pharmacy,Pathology",
        Upload: "",
      },
      {
        Id: 5,
        ...
        PatientType: "OPD",
        AddedBy: "Atharv P",
        Description: "Radiology,Admission Request (Non Surgical)",
        Upload: "",
      },
      {
        Id: 5,
        DateAndTime: "08/02/2022 01:30 AM",
        PatientType: "IPD",
        AddedBy: "Swapnil Jain",
        Description: "Admission Request (Non Surgical)",
        Upload: "",
      },
      {
        Id: 5,
        ...
        PatientType: "OPD",
        AddedBy: "David N",
        Description: "Admission Request (Surgical),Pharmacy",
        Upload: "",
      },
      {
        Id: 5,
  ...
  const resultList = {
    ...
    result: [
      ...
      {
        Description: "Admission Request (Surgical)",
        SelectOptions: "4",
        ReScheduledDate: "",
      },
      {
        Description: "Vaccination Requested",
        SelectOptions: "5",
        ReScheduledDate: "",
      },
      {
      ...
      {
        Description: "Other Consultant Reference",
        SelectOptions: "7",
        ReScheduledDate: "",
      },
      {
        Description: "Cardiac OPD",
        SelectOptions: "8",
        ReScheduledDate: "",
      },
      {
    ...
    result: [
      {
        Id: 1,
        UHID: "2012510",
        PatientName: "Ajay Patil",
        Gender: "Male",
        Age: "27",
        Date: "D 27 M 5 Y 2022",
        Address: "Warje",
      },
      {
        Id: 2,
      ...
      },
      {
        Id: 4,
        UHID: "2012513",
        PatientName: "Sonali Zodge",
        Gender: "Female",
        Age: "28",
        Date: "D 27 M 5 Y 2020",
        Address: "Wadgaon",
      },
      {
        Id: 5,
        UHID: "2012514",
        PatientName: "Sahil Bhowate",
        Gender: "Male",
        Age: "25",
        Date: "D 27 M 5 Y 2019",
        Address: "Kothrud",
      },
      {
        Id: 6,
        UHID: "2012515",
        PatientName: "Sanjay Choure",
        Gender: "Male",
        Age: "78",
        Date: "D 27 M 5 Y 2021",
        Address: "Chinchwad",
      },
      {
        Id: 7,
        UHID: "2012516",
        PatientName: "Supriya Patil",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2027",
        Address: "Satara",
      },
      {
        Id: 8,
        UHID: "2012519",
        PatientName: "Komal Satam",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2026",
        Address: "Kothrud",
      },
      {
        Id: 9,
        UHID: "2012520",
        PatientName: "Seeta Raman",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2025",
        Address: "Pune",
      },
      {
        Id: 10,
        UHID: "2012521",
        PatientName: "Shivaji Rao",
        Gender: "Male",
        Age: "25",
        Date: "D 27 M 5 Y 2028",
        Address: "Kothrud",
      },
      {
        Id: 11,
        UHID: "2012524",
        PatientName: "Pankaj Wani",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2029",
        Address: "Bharti Nagar",
      },
      {
        Id: 12,
        UHID: "2012530",
        PatientName: "Sarita Kamble",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2030",
        Address: "Mahabaleshwar",
      },
      {
        Id: 13,
        UHID: "2012821",
        PatientName: "Padmaja Kulkarni",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2031",
        Address: "Wai",
      },
      {
        Id: 14,
        UHID: "2012921",
        PatientName: "Shree Deshmukh",
        Gender: "Male",
        Age: "25",
        Date: "D 27 M 5 Y 2032",
        Address: "Kothrud",
      },
      {
        Id: 15,
        UHID: "2012451",
        PatientName: "Shreemant Sadekar",
        Gender: "Female",
        Age: "25",
        Date: "D 27 M 5 Y 2033",
        Address: "Kothrud",
      },
    ],
  };
  ...
  const [opdcoordinatorenable, setOpdCoordinatorEnable] = React.useState(false);
  const handleChange = () => {
    console.log("search fun call");
  };
  // const[]
  return (
    <>
      <div className="mt-20 px-2 w-full bg-white pb-6">
        <div className="lg:flex lg:space-x-1 w-full">
            ...
            <div className="  lg:grid-cols-1 grid gap-2 w-full my-2 lg:my-0 ">
              ...
              <div className="">
                <PatientVisitMarkedListingTable
                  ...
                  opdcoordinatorenable={opdcoordinatorenable}
                />
              </div>
            </div>
          </form>
          <div className="lg:border-l-2 w-full lg:grid  lg:grid-cols-1 xl:gap-2 md:mt-2  px-2">
            <div className="">
              <fieldset
                className="border border-gray-300 col-span-3 w-full lg:py-1
               text-left lg:px-2 md:p-2 rounded "
              >
                <legend className="text-slate-900 pr-4 font-bold text-lg">
                  OPD Coordinator
                </legend>
                <fieldset className="col-span-3 w-full lg:py-1 text-left lg:px-2 rounded ">
                  <div className="grid lg:grid-cols-3 md:grid-cols-2 justify-items-start">
                    <div className="flex gap-2">
                      <h1 className=" lg:space-x-28 md:space-x-14  text-slate-900 items-center  flex ">
                        <h5 className="text-slate-900 font-bold">UHID</h5>{" "}
                        <span className="">:</span>
                      </h1>
                      <h1 className="font-normal text-slate-900 lg:space-x-20">
                        {opdcoordinator.UHID}
                      </h1>
                    </div>

                    <div className="flex items-center lg:space-x-6 md:space-x-12">
                    ...
                    <div className="flex items-center md:space-x-12 lg:space-x-12">
                      <h5 className="text-slate-900 pr-4 font-bold">Age </h5>{" "}
                      <label className="text-slate-700">
                        : {opdcoordinator.Date}
                      </label>
                    </div>
                    <div className="flex items-center space-x-2 lg:col-span-2 lg:space-x-6">
                    ...
                    <div className="flex items-center lg:space-x-4 w-full md:space-x-4">
                      <h5 className="text-slate-900 pr-4 font-bold">
                        Address{" "}
                      </h5>{" "}
                      <label className="text-slate-700">
