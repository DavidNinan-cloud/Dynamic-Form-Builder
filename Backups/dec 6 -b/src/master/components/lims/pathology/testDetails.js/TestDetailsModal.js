      ...
      onSuccess: (data) => {
        ...
        if (data) {
          ...
          resetDetails({
            ...
            machine: obj.machine,
            timeCompletion: obj.timeCompletion,
            cultureSensitivityTest: obj.cultureSensitivityTest,
            hasAuthentication: obj.hasAuthentication,
            authorizationLevel: obj.authorizationLevel,
            isConsent: obj.isConsent,
            isuniqueSampleNoRequired: obj.isUniqueSampleNoRequired,
            isHistopathTest: obj.isHistopathTest,
            techniqueUsed: obj.techniqueUsed,
          });
