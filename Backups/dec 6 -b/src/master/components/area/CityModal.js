...
import {
  ...
  getCityById,
  updateCity,
} from "./../../services/area/CityService";
...
function CityModal(props) {
  console.log("This is City Modal Component");
  ...
  const onSubmitDataHandler = (data) => {
    ...
    if (props.edit === true) {
      ...
      let updateObj = {
        active: data.active, //to be corrected at the backend
  ...
  //update the taluka dropdown upon change in district dropdown. This is event listener function for state dropdown
  ...
  const { status } = useQuery(
    ...
    () => {
      if (props.idValue && openPut !== true) {
        return getCityById(props.idValue);
      }
    },
      ...
      onSuccess: (data) => {
        ...
        if (data) {
          ...
          let resetObj = {
            ...
            country: {
              value: data.data.result.taluka.district.state.country.value,
              label: data.data.result.taluka.district.state.country.label,
            },
            state: {
              value: data.data.result.taluka.district.state.value,
              label: data.data.result.taluka.district.state.label,
            },
            district: {
              value: data.data.result.taluka.district.value,
              label: data.data.result.taluka.district.label,
            },
            taluka: {
              value: data.data.result.taluka.value,
              label: data.data.result.taluka.label,
            },
            cityName: data.data.result.cityName,
            cityCode: data.data.result.cityCode,
  ...
  const { mutate: postCity } = useMutation(addNewCity, {
    onSuccess: (res) => {
      const result = {
                        ...
                        inputRef={{
                          ...register("state", {
                            onChange: (e) => {
                              ...
                              console.log(
                                "Selected state object is " + e.target.value
                              );
                            },
                          }),
                        }}
