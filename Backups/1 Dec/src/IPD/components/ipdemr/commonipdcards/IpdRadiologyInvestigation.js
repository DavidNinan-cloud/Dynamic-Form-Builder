...
import AddIpdRadioInvestigationModal from "../emrcomponentsmodals/AddIpdRadiologyInvestigationModal";

const IpdRadiologyInvestigation = (props) => {
  let result = props.radiologyInvestigations;
  ...
  return (
    <>
        ...
        >
          <CardContent>
            <div className="flex justify-between py-2 bg-[#DEFFD6] -mt-2">
              ...
              <div>
                {props.radiologyInvestigations !== null &&
                props.radiologyInvestigations.length > 0 ? (
                  <button
      ...
      >
        ...
        >
          <AddIpdRadioInvestigationModal
            setOpen={setOpen}
            editInfo={editInfo}
            dataId={dataId}
            investigations={props.radiologyInvestigations}
          />
        </Box>
      </Modal>
...
export default IpdRadiologyInvestigation;
