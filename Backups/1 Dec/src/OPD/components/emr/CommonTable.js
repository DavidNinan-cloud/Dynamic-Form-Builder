...
export default function CommonTable(props) {
  ...
  //   const handleReportChange = (target) => {
  //     const result = investigationReport.onProfilePicChange(target);
  //   };

  //   React.useEffect(() => {
  //     // console.log("Upload Data", data);
  //     investigationReport.fileName.length === 0
  //       ? setReportPic("")
  //       : setReportPic(investigationReport.path);
  //     setReportName(investigationReport.fileName);
  //   }, [investigationReport]);
