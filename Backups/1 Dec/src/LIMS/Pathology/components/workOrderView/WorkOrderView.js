...
import ReportDetailsModal from "../reportDetails/ReportDetailsModal";
import RecollectReprocessModal from "./RecollectReprocessModal";
...
const WorkOrderView = () => {
  ...
  const handelOpenRecollectModal = () => setOpenRecollectModal(true);

  //handelClose function closes the modal form
  const handleCloseRecollectModal = () => setOpenRecollectModal(false);
      ...
      <div className="container w-full grid px-2 lg:px-5  pt-10 mt-8 md:rounded-md">
        <div className="flex flex-col justify-center">
          <div className="grid grid-cols-2 gap-2 my-2">
            ...
            {openRecollectModal ? (
              <RecollectReprocessModal
                open={openRecollectModal}
                handleClose={handleCloseRecollectModal}
                setOpen={setOpenRecollectModal}
                handelOpen={handelOpenRecollectModal}
              />
            ) : null}
          </div>
        </div>
