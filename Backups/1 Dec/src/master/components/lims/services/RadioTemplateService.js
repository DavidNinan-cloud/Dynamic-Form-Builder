...
//fetch the testResultApi
export const getTestResultType= async () => {
  return await apiClient.get(`tests/testResultType/dropdown`, {
    headers: authHeader(),
  });
};

//fetch the radiologist list
export const getRadiologistList= async () => {
  return await apiClient.get(`employees/radiologistDropDown`, {
    headers: authHeader(),
  });
};
