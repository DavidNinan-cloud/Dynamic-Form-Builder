...
export default function CabinTable(props) {
  ...
  const { 
    ...
    dataResult ,
    setDataResult,
    page, setPage, rowsPerPage, setRowsPerPage, count } = props;
                  ...
                  >
                    ...
                    >
                      <TableSortLabel
                        ...
                        onClick={createSortHandler("activeStatus")}
                      >
                        <span className="text-gray-600 font-bold whitespace-nowrap">
                          Status
                        </span>
                      ...
                      return (
                        <TableRow>
                          ...
                          <TableCell className='flex space-y-1'
                            // sx={{
                            // }} Remove for bottom line straight
                          >
                          ...
                          <TableCell className="whitespace-nowrap">
                            {cabin.lastModifiedBy}
                          </TableCell>

                          <TableCell className="whitespace-nowrap">
                            {cabin.lastModifiedDate}
                          </TableCell>
