...
} from "../../../usermanagement/services/assignfunctionalityServices/AssignFunctionalityServices";
...
export default function MapUserFunctionality({
 tableData,
 setTableData,
 expandPanal,
 setExpandPanal,
 ...
 const ChildrenOfTheForest = ({ indexArr, dataArr }) => {
 return (
 <div>
 {dataArr.subFunction &&
 dataArr.subFunction.map((subSubRow, subSubIndex) => {
 return (
 <div
 key={subSubIndex}
 className={
 subSubRow.permissions ? "flex flex-row w-full" : "ml-5"
 }
 >
 <div className={subSubRow.permissions ? "w-6/12 " : "w-full"}>
 <FormControl
 sx={
 ...
 render={({ field }) => (
 <FormControlLabel
 label={subSubRow.functionality}
 control={
 <Checkbox
 checked={subSubRow.isChecked}
 defaultChecked={subSubRow.isChecked}
 onChange={(e) => {
 ...
 className="w-full items-center pl-5 text-gray-800 font-bold tracking-wider mr-2"
 />
 )}
 name={`module[${subSubIndex}].${subSubIndex.functionality}`}
 control={control}
 defaultValue={subSubRow.isChecked}
 />
 </FormControl>
 </div>
 ...
 {dataArr.permissions &&
 dataArr.permissions.map((SubpermissionRow, SubpermissionIndex) => {
 return (
 <div key={SubpermissionIndex} className="ml-10 ">
 <FormControl
 sx={{
 marginLeft: {
 sm: "0.5rem",
 ...
 render={({ field }) => (
 <FormControlLabel
 label={SubpermissionRow.permission}
 control={
 <Checkbox
 checked={SubpermissionRow.isChecked}
 defaultChecked={SubpermissionRow.isChecked}
 onChange={(e) => {
 let value = e.target.checked;
 ...
 className="w-full items-center pl-5 md:pl-0 text-gray-800 font-bold tracking-wider mr-2"
 />
 )}
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].permissions[
 indexArr[2]
 ].isChecked = value;
 } else if (depth == 3) {
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].permissions[indexArr[3]].isChecked = value;
 } else if (depth == 4) {
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].permissions[indexArr[4]].isChecked = value;
 } else if (depth == 5) {
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].permissions[
 indexArr[5]
 ].isChecked = value;
 } else if (depth == 6) {
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ...
 indexArr[5]
 ].permissions[indexArr[6]].isChecked = value;
 } else if (depth == 7) {
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ...
 indexArr[5]
 ].subFunction[indexArr[6]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].permissions[indexArr[6]].permissions[indexArr[7]].isChecked = value;
 } else if (depth == 8) {
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ...
 indexArr[5]
 ].subFunction[indexArr[6]].subFunction[indexArr[7]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]].subFunction[indexArr[7]].permissions[
 indexArr[8]
 ].isChecked = value;
 } else {
 ...
 // set parents false
 arr[indexArr[0]].subFunction[indexArr[1]] = checkAllPermissionsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]]
 );
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]] = setParentsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]]
 );
 arr[indexArr[0]] = setParentsFalse(arr[indexArr[0]]);
 } else if (depth == 4) {
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]] = checkAllPermissionsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ] = setParentsFalse(
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[
 indexArr[4]
 ] = checkAllPermissionsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]] = setParentsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]] = setParentsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 ...
 indexArr[5]
 ].subFunction[indexArr[6]].permissions[indexArr[7]].isChecked = value;
 ...
 indexArr[5]
 ].subFunction[indexArr[6]] = checkAllPermissionsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 ...
 indexArr[5]
 ].subFunction[indexArr[6]].subFunction[
 indexArr[7]
 ] = checkAllPermissionsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]].subFunction[indexArr[7]]
 );
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]] = setParentsFalse(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]]
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].isChecked = value;
 arr[indexArr[0]].subFunction[indexArr[1]] = seekChildren(
 arr[indexArr[0]].subFunction[indexArr[1]],
 value
 );
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]] = seekChildren(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]],
 value
 );
 ...
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[
 indexArr[2]
 ].subFunction[indexArr[3]].subFunction[indexArr[4]] = seekChildren(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]],
 value
 );
 ...
 indexArr[5]
 ].subFunction[indexArr[6]] = seekChildren(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]],
 ...
 indexArr[5]
 ].subFunction[indexArr[6]].subFunction[indexArr[7]] = seekChildren(
 arr[indexArr[0]].subFunction[indexArr[1]].subFunction[indexArr[2]]
 .subFunction[indexArr[3]].subFunction[indexArr[4]].subFunction[
 indexArr[5]
 ].subFunction[indexArr[6]].subFunction[indexArr[7]],
 ...
 childSubFunc[i].subFunction = setChildren(
 childSubFunc[i].subFunction,
 value
 );
 ...
 childArr[j].permissions = setPermissions(
 childArr[j].permissions,
 value
 );
 }
 // else {
 ...
 lg={12}
 sm={12}
//  sx={{ maxHeight: "24rem", overflowY: "scroll" }}
 className=""
 >
 {tableData.length > 0 ? (
 ...
 expandData[index] = !expandPanal[index];
 ...
 {row.permissions &&
 row.permissions.map(
 (permissionRow, permissionIndex) => {
 return (
 <div key={permissionIndex} className="ml-5 ">
 <FormControl>
 <Controller
 render={({ field }) => (
 <FormControlLabel
 label={permissionRow.permission}
 control={
 <Checkbox
 checked={
 ...
 control={control}
 defaultValue={permissionRow.isChecked}
 />
 </FormControl>
 </div>
 );
