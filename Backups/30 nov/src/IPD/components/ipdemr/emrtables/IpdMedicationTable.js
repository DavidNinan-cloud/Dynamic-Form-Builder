...
export default function IpdMedicationTable(props) {
  ...
  React.useEffect(() => {
    console.log("Table Data", props.data.result);
  }, [props]);

  //table start
  return (
    <div className="w-full h-auto overflow-scroll scrollbar-thin  scrollbar-thumb-gray-300 scrollbar-track-slate-50 pb-2 ">
