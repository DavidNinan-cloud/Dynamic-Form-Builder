...
export default function Taluka() {
  ...
  const handleChange = (autoSearchString) => {
    ...
    if (autoSearchString !== "") {
      ...
      autoSearchTaluka(autoSearchString)
  ...
  function editRow(talukaInfo) {
    setEdit(true);
    console.log(talukaInfo);
    console.log(talukaInfo.Id);
    setIdValue(talukaInfo.Id);
    ...
    <>
      <div className="w-full grid pt-10 px-6 mt-8 md:rounded-md">
        <div className="flex justify-center text-xl">
          <h1 className="text-black font-Poppins lg:hidden ">Taluka</h1>
        </div>
          ...
          <div className=" flex items-center w-full gap-2">
            ...
            <div className="flex gap-2 items-center w-full xl:w-3/4">
              <SearchBar
                ...
                placeholder="Search by Taluka Code/Taluka"
                dataArray={options}
