...
const Machine = () => {
  ...
  function editRow(machineInfo) {
    setEdit(true);
    console.log("machineInfo", machineInfo);
    console.log(machineInfo.Id);
    setIdValue(machineInfo.Id);
  ...
  useEffect(() => {
    ...
    fetchAllMachines(defaultParams)
      .then((response) => {
