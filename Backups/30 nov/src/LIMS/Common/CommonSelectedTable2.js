...
const CommonSelectionTable2 = (props) => {
  const {
    rows,
    headCells,
    order,
  ...
  return (
    <Box sx={{ width: "100%" }} component={Paper} elevation={2}>
      <TableContainer>
              ...
              .map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{row.observedValue}</TableCell>
...
export default CommonSelectionTable2;
