...
import { saveSettlementDetails } from '../../services/BillSettlement/BillSettlementServices';
import ConfirmationModal from '../../../Common Components/ConfirmationModal';
import CommonBackDrop from '../../../Common Components/CommonBackDrop/CommonBackDrop';

// .max(Yup.ref('maxCapacity'), "Cannot Exceed Max Capacity") will do the work.


export default function SelectedBillTable({
  ledgerData,
  isSelfSettlement, 
  postApiCall,   
  setPostApiCall,
  unitId}) {
    ...
    const headers = ['Bill Amount','Self Balance','Concession %', 'Concession Amount', 'Net Settlement Amount', 'Net Pay Amount', 'Net Self Balance']
  ...
  useEffect(()=>{
    if(ledgerData.totalSelfBalance >= Number(concessionAmt)){
      setValue('netSettlementAmount',ledgerData.totalSelfBalance - Number(concessionAmt), {
        shouldValidate: true,
      })
