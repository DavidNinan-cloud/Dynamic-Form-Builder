...
export default function DenailAdmissionModal(props) {
  ...
  return (
    <div>
      <Modal
        open={props.openDenialAdmissionModal}
        onClose={() => {
          props.handleCloseDenialAdmissionModal();
          //   reset(defaultValues);
        }}
          ...
          <fieldset className="border border-gray-400 w-full text-left px-4 rounded">
            ...
            <div className="grid gap-2 w-full py-2">
                    ...
                    //   error={errors.unit}
                      name="denailreason"
                    //   dataArray={unit}
                      placeholder="Select Deny Reason"
                      isMulti={false}
                      isSearchable={false}
                    />
