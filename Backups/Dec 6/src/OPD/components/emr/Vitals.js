...
import ViewVitals from "./emrcomponents/ViewVitals";
import { yupResolver } from "@hookform/resolvers/yup";
import * as yup from "yup";
import InputField from "../../../Common Components/FormFields/InputField";

const Vitals = (props) => {
  console.log("Props Vitals", props);
  ...
  const handleInputChange = (event) => {
    ...
    console.log("sliderValue", props.vitalsValue.height);
  };
  ...
  let BMIValue = 0;
  useEffect(() => {
    console.log("props.vitalsValue", BMIValue);
      ...
      <div className="ml-2  h-auto ">
        ...
        >
          <CardContent className="">
            <div className="flex justify-between  bg-[#FFD4E3] py-2 ">
