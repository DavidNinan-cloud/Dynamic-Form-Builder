...
export const fetchAllParameterUnits = async (searchParameterUnitObj) => {
  ...
  return await apiClient.post("labunits/labunitslist", searchParameterUnitObj, {
    headers: authHeader(),
  });
};
...
export const addNewParameterUnit = async (createParameterUnit) => {
  ...
  return await apiClient.post(`/labunits`, createParameterUnit, {
    headers: authHeader(),
  });
};
...
export const getParameterUnitById = async (id) => {
  return await apiClient.get(`/labunits/${id}`, {
    headers: authHeader(),
  });
};
...
export const autoSearchParameterUnit = async (searchString) => {
  return await apiClient.get(`labunits/search/${searchString}`, {
    headers: authHeader(),
  });
};
...
export const updateParameterUnit = async (updateParameterUnitObj) => {
  return await apiClient.put(`/labunits`, updateParameterUnitObj, {
    headers: authHeader(),
  });
};
...
export const deleteParameterUnitById = async (id) => {
  return await apiClient.delete(`/labunits/${id}`, {
    headers: authHeader(),
  });
};
