...
import AppointmentBookingSourceModal from "../appointment/AppointmentBookingSourceModal";
//LodingSpinner
import LoadingSpinner from "../../components/common/loadingspinner/loadingSpinner";
//internal project functions and componants import
import CommonBackDrop from "../../../Common Components/CommonBackDrop/CommonBackDrop";
import {
  autoSearchApptBookingSource,
  fetchAllApptBookingSource,
  deleteAppointmentBookingSourceById,
...
//function start
export default function AppointmentBookingSource() {
  ...
  useEffect(() => {
    ...
    fetchAllApptBookingSource(defaultParams)
      .then((response) => {
  ...
  const handleChange = (autoSearchString) => {
    if (autoSearchString !== "") {
      ...
      autoSearchApptBookingSource(autoSearchString)
  ...
  const autoSelectedValue = (value) => {
    ...
    if (value === null) {
      ...
      searchValue = value.appointmentbooksource;
    }
  };

  //event listener function for edit icon
  function editRow(appointmentbookingsource) {
    setEdit(true);
    console.log(appointmentbookingsource);
    console.log(appointmentbookingsource.Id);
    setIdValue(appointmentbookingsource.Id);
  ...
  function deleteRecord() {
    ...
    deleteAppointmentBookingSourceById(deleteId)
      .then((response) => {
    ...
    <>
      ...
      <div className="w-full grid pt-10 px-6 mt-8 md:rounded-md">
        <div className="flex justify-center text-xl">
          <h1 className=" text-gray-700  font-Poppins lg:hidden w-[60%]">
        ...
        <div className="flex gap-2 w-full items-center mt-2">
          ...
          <h1 className="text-xl text-gray-700 font-Poppins hidden lg:block lg:w-[45%] md:w-[0%]">
            Appointment Booking Source
          </h1>
        ...
        spinner === false ? (
          <CommonMasterTable
            tableApiFunc={fetchAllApptBookingSource}
            searchString={searchString}
...
// end appt booking source function
