...
function StockAdjustment(props) {
  ...
  return (
    <div className="mt-20 px-6">
      ...
      <div className="flex flex-col-reverse lg:flex-row lg:space-x-5 xl:space-x-3 w-full ">
        <div className="lg:w-[55%] xl:w-[70%] border rounded bg-white p-2  mt-2 lg:mt-0 lg:pb-0 lg:bg-none lg:border-none ">
