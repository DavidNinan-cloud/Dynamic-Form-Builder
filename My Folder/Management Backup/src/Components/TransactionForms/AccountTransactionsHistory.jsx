...
export default function AccountTransactionsHistory() {
  ...
  return (
    ...
    <div className='min-h-screen bg-slate-100 pt-4'>
        <p className="text-xl font-semibold tracking-wide mx-4 w-full text-center">Account Transactions History 
        </p>

        <div className='w-full p-5'>
            <Grid container spacing={1} >
                <Grid item lg={6} sm={4} className="z-50">
                    <SearchBar
                    name="inputSearch"
                    placeholder="Search by Transaction For"
